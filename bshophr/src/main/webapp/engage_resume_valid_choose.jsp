...
<html>
 ...
 <form id="frm">
    <table width="100%">
        <tr>
            <td>
                <font color="black">您正在做的业务是：招聘管理--简历管理--有效简历查询 </font>
            </td>
        </tr>
        <tr>
            <td align="right">
...
<script>
	...
	$("#humanMajorKindName").change(function(){
	 ...
	 $("#mysubmit").click(function(){
	 	...
	 	frm.action="zjlEngageResume/"+hiddenMajorKindName+"/"+humanMajorName+"/"+keyWord+"/"+startdate+"/"+enddate+"/queryChooseValid.do";
	 	frm.submit();
