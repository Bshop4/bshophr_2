...
<script type="text/javascript">
	...
	$("#djtQlSearch").click(function(){
		...
		window.location.href="/bshophr/recoveryLocate/djtSearch.do?firstKindId="+firstSelect
	...
	$("#djtQueryKeywords").click(function(){
		...
		window.location.href="recoveryKeywords/djtSearch.do?firstKindId="+firstKindId
