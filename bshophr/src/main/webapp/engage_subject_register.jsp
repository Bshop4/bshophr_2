...
<body>
	...
	<table width="100%" border="1" cellpadding=0 cellspacing=1
		...
		<tr>
			...
			<td class="TD_STYLE2"><input type="hidden" name="firstKindId">
				<select name="firstKindName" class="SELECT_STYLE1"
				id="firstKindName">
					<option>--请选择--</option>
					<option>${cq.firstKindName }</option>
			</select></td>
			<td class="TD_STYLE1">试题二级级分类</td>
			<td class="TD_STYLE2"><input type="hidden" name="secondKindId">
				...
				id="secondKindName">
					...
					<td class="TD_STYLE2"><input type="text" name="registTime"
						id="nowTime" disabled="disabled" class="INPUT_STYLE2"></td>
		</tr>
		<tr>
			<td class="TD_STYLE1" height="50px">题干</td>
			<td class="TD_STYLE2" colspan="7"><textarea rows="3" cols="3"
