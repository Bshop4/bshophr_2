...
<body>
	<form method="post" action="querybzbg.do?operate=list">
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				...
				<td class="TD_STYLE2"><input type="text" name="sstid"
					value="${sstid}" class="INPUT_STYLE1"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">请输入关键字</td>
				<td class="TD_STYLE2"><input type="text" name="sdesigner"
					value="${sdesigner}" class="INPUT_STYLE1"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">请输入建档时间</td>
				<td width="84%" class="TD_STYLE2"><input name="srtime1"
					onclick="aa('srtime1')" type="text" class="INPUT_STYLE2"
					id="date_start" style="width: 24%" value="${srtime }" size="30">
					至 <input type="text" name="srtime2" onclick="aa('srtime2')"
					value="${srtime }" style="width: 24%" class="INPUT_STYLE2"
					id="date_end"> （YYYY-MM-DD）</td>
			</tr>
		</table>
