...
<html>
  <head>
    ...
    <title>My JSP 'third_kind_delete.jsp' starting page</title>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td width="51%" align="right"><input type="button" value="删除" class="BUTTON_STYLE1" onclick="javascript:doDel('${param.id }&pageNo=${pageNo }')">
