			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<c:forEach items="${list}" var="sk">
					<tr>
						...
						<td class="TD_STYLE2">
							<a href="third_kind_delete.jsp?id=${sk.ftkId }&message=${sk.firstKindId}/${sk.firstKindName}/${sk.secondKindId}/${sk.thirdKindId}/${sk.secondKindName}${sk.thirdKindName}/">删除</a>
						</td>
					</tr>
				</c:forEach>
				</c:if>
