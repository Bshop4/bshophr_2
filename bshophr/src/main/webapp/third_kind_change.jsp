...
<body>
<form name="configfilethirdkindForm" method="post" action="/hr/configfilethirdkind.do">
<table width="100%" >
  <tr>
    <td> 
  ...
  <tr>
    <td align="right"><input type="button" value="提交" class="BUTTON_STYLE1" onclick="window.location.href='third_kind_change_success.jsp'">
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  ...
  <tr>
    ...
    <td class="TD_STYLE2"><input type="text" name="item.firstKindName" value="外包组" readonly="readonly" class="INPUT_STYLE1"></td>
  </tr>
  <tr>
    <td class="TD_STYLE1">零售</td>
    <td class="TD_STYLE2">
	<select name="item.thirdKindIsRetail" type="text" class="INPUT_STYLE1">
  ...
  <tr>
    ...
    <td class="TD_STYLE2"><textarea name="item.thirdKindSaleId" rows="4" class="TEXTAREA_STYLE1">1</textarea></td>
  </tr>
</table>
</form>
</body>
