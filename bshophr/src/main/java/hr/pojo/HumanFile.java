...
public class HumanFile implements java.io.Serializable {
	...
	/** full constructor */
	public HumanFile(Short hfdId, String humanId, String firstKindId, String firstKindName, String secondKindId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HumanFile))
			return false;
		HumanFile castOther = (HumanFile) other;
